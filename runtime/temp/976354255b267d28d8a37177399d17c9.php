...
<div class="page-sidebar" id="sidebar">
  ...
  <!-- /Sidebar Menu -->
      ...
      <div class="page-content">
        ...
        <!-- Page Body -->
        <div class="page-body">
          <button type="button" tooltip="添加权限" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('auth_rule/add'); ?>'"> <i class="fa fa-plus"></i> Add
          </button>
          <div class="row">
                      ...
                      <table class="table table-bordered table-hover">
                        <thead class="">
                          <tr>
                            ...
                            <th class="text-center">控制器/方法名</th>
                        ...
                        <?php if(is_array($authRules) || $authRules instanceof \think\Collection || $authRules instanceof \think\Paginator): $i = 0; $__LIST__ = $authRules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                          <tr>
                            ...
                            <td align="left">
                              <?php if($vo['level'] != 0): ?>|<?php endif; ?><?php echo str_repeat('—',$vo['level']*3)?><?php echo $vo['title']; ?>
                            </td>
