...
<div class="page-sidebar" id="sidebar">
  ...
  <!-- /Sidebar Menu -->
      ...
      <div class="page-content">
        ...
        <!-- Page Body -->
        <div class="page-body">
          <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('auth_group/add'); ?>'"> <i class="fa fa-plus"></i> Add
          </button>
          <div class="row">
