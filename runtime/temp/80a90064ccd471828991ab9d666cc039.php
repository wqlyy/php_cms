                              ...
                              <tr>
                                <td>
                                  <label>
                                    ...
                                    <input <?php $arr=explode(',',$groups['rules']);if(in_array($vo['id'],$arr)){echo 'checked';}?> dataid="id-<?php echo $vo['dataid']; ?>" class="inverted checkbox-parent <?php if($vo['level'] != 0): ?>checkbox-child<?php endif; ?>" type="checkbox" name="rules[]" value="<?php echo $vo['id']; ?>">
