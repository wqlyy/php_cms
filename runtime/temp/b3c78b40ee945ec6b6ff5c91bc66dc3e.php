                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <select name="group_id" class="form-control">
                            ...
                            <option <?php if($vo['id'] == $authGroupAccess['group_id']): ?>selected<?php endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></option>
