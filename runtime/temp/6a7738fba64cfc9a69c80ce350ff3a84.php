                  ...
                  <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input class="form-control" required name="cnname" type="text">
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input class="form-control" required name="enname" type="text">
                        </div>
                        <p class="help-block col-sm-4 red">* 必填</p>
                      </div>
                      <div class="form-group">
